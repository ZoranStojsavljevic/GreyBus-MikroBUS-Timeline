## GreyBus-MikroBUS-Timeline Repo
...
The author of the repo will keep this repo open for the time being, in order
to make very clear understanding of the MikroBUS architecture, connecting
defn. (.h) enhanced by Grey Bus MikroBUS defn. (.h) files with MikroBUS
Manifesto used.
